  ...
  return (
    <div className='h-full px-8 flex-col justify-center grow lg:flex-col lg:justify-between lg:px-0 lg:mt-[3.5rem] lg:max-w-[58.75rem] lg:max-h-[43.625rem]'>
        <section className='mt-4 w-full h-auto flex justify-center relative lg:justify-between lg:border lg:p-6  '>
          ...
          <Link href={'/profile/edit'} className='right-0 absolute text-input text-center underline underline-offset-1 hover: cursor-pointer w-[2.5rem] lg:mr-5'>
             Editar
          </Link>
        </section>
      ...
      >
        ...
        <section className="flex flex-col justify-center gap-4 ">
          ...
          className={'text-center text-button__line underline hover:cursor-pointer lg:hidden '}
          onClick={() => { }}
          > 
            Cambiar contraseña
          </Link>
