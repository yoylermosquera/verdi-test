...
function EditInfo() {
  return (
    <div className='h-full px-8 '>
        <section className=' mt-4 mb-10 w-full flex justify-center  '>
      ...
      <form
        ...
        className="lg:max-w-[360px] w-full border h-full"
      >
        <section className="flex flex-col gap-6 mt-0 border-gold-dark bg-gold-dark grow">
        ...
        <section className="flex flex-col justify-center align-bottom ">
