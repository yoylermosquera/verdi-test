...
export const Portrait = (props: IconProps) => {
  ...
  return (
    ...
    >
        ...
        <rect x="1" y="5.90909" width="18" height="13.0909" rx="1" stroke={color} strokeWidth="1.8" strokeLinejoin="round"/>
        <path d="M4.5 5.90909L10 1L15.5 5.90909" stroke={color} strokeWidth="1.8" strokeLinejoin="round"/>
