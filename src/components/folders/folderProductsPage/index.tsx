...
import FolderTypeHero from '../folderTypeHero';
   ...
   <section className='w-full h-full'>
    ...
    <section className='w-full h-full pt-4 px-4 flex flex-row justify-between lg:hidden'>
      <section className='flex flex-col gap-6 w-full px-2'>
        <FolderTypeHero description='CARPETS' folderIconName='CarpetLarge' className=' mx-auto'/>
        {
...
export default FolderProductsPage;
